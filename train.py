...
if __name__ == '__main__':
    ...
    paraser.add_argument("--save_model_path",
                         default="/home/jade/sda2/Models/Image_Classif/",
                         help="path to save model")
    paraser.add_argument("--dataset_name", default="car",
                         help="dataset_name")
    paraser.add_argument("--dataset_path",
                         default="/home/jade/sda2/Data/CARDATA/Tfrecords/car_2020-01-21_train.tfrecord",
                         help="the dataset_path ")
    paraser.add_argument("--checkpoint_path",
                         default="/home/jade/sda2/CheckPoint/resnet_v2_101_2017_04_14/resnet_v2_101.ckpt",
                         help="the checkpoint_path ")
    ...
    paraser.add_argument("--checkpoint_exclude_scopes",
                         default='resnet_v2_101/logits/biases,resnet_v2_101/logits/weights',
                         help="the checkpoint_exclude_scopes ")
